...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_js_toggle_button__ = __webpack_require__(3);
...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('index-nova-toggle', __webpack_require__(4));
    Vue.component('detail-nova-toggle', __webpack_require__(7));
    Vue.component('form-nova-toggle', __webpack_require__(10));
});
    ...
    methods: {
        toggle: function toggle() {
            ...
            Nova.request().post('/nova-vendor/nova-toggle/toggle/' + this.resourceName, {
                value: this.value ? this.field.true_value : this.field.false_value,
                fieldName: this.field.attribute,
                resourceId: this.resourceId
            }).then(function (res) {
                if (res.data.success) _this.$toasted.show(_this.field.indexName + ' changed', { type: 'success' });else _this.$toasted.show(_this.field.indexName + ' change error', { type: 'error' });
            });
        }
    },
